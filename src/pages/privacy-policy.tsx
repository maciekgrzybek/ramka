export const PrivacyPolicy = () => (
  <div className="px-4 md:px-8 plain-text">
    <div>
      <div>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Ramka.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Ramka, accessible from{' '}
              <a
                href="https://ramka.maciekgrzybek.dev/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://ramka.maciekgrzybek.dev/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: pils.dsgn@gmail.com</li>
        </ul>
      </div>
    </div>
  </div>
